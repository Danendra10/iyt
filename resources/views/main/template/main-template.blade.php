                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="header-icons">
                                        <a class="shopping-cart" href="cart.html"><i class="fas fa-shopping-cart @yield('active-class')"></i></a>
                                        <a class="mobile-hide search-bar-icon" href="#"><i class="fas fa-search @yield('active-class')"></i></a>
