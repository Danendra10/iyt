@extends('partner/template/partner-control-template')

@section('page-title') Partner Dashboard @stop
                                            ...
                                            <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                    <div class="img-box"><img
                                                            src="partner/images/layout_img/user_img.jpg" alt=""></div>
                                                    <p class="testimonial">Sed ut perspiciatis unde omnis iste natus
                    ...
                    <div class="dash_blog">
                        <div class="dash_blog_inner">
                            ...
                            <div class="msg_list_main">
                                <ul class="msg_list">
                                    <li>
                                        <span><img src="partner/images/layout_img/msg2.png" class="img-responsive"
                                                alt="#" /></span>
                                        <span>
                                    ...
                                    <li>
                                        <span><img src="partner/images/layout_img/msg3.png" class="img-responsive"
                                                alt="#" /></span>
                                        <span>
